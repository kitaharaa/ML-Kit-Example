...
import com.google.mlkit.vision.demo.OcrWord
import com.google.mlkit.vision.demo.ScopedExecutor
import com.google.mlkit.vision.demo.TextOverlayView
...
//    }
  ...
  fun runOcr(bitmap: Bitmap, onResult: (List<OcrWord>) -> Unit) {
          ...
          for (line in block.lines) {
            for (element in line.elements) {
              element.boundingBox?.let { rect ->
                words.add(OcrWord(element.text, rect))
              }
            }
          }
        }
